...
* **Statistical Quality Control:** Walter Shewhart's
methods in the 1920s laid the foundation for
quality control using statistical analysis.
* **Quality Gurus and Japanese Advancements:** Post-
WWII, Deming, Juran, and others introduced
concepts like SPC, TQC, JIT, and Kaizen in Japan,
emphasizing continuous improvement and
employee involvement.
* **International Standards and Awards:** The
establishment of the ISO 9000 series in 1987 and
recognition programs like the Malcolm Baldrige
National Quality Award institutionalized quality
excellence worldwide.

```txt
This was one part or the one phase of quality coming to the second phase, which was during mid 20th
century.

That was the era when Japan was coming out of World War two, and that was the time
lots and lots of quality improvements have happened in Japan, but even prior to that, Walter Shewhart

developed the control charts in 1920s and then in post World War Two time in Japan.
Doctor Deming and Juran played a great role in the development of quality concepts.
That was the time when SPC or the Statistical Process Control, TQC Total Quality Control, JIT just in
time, Kaizen, which is continuous improvement.
So these were the concepts which were being developed in Japan.

Emphasis was on each and every person in the company working towards the quality, starting from the
workers to the management.

So role of employees was very important.
Quality circles were being formed to improve the quality.
```

### Modern Era

* **Six Sigma and Lean Manufacturing:** Introduced in
the 1980s, these methodologies sought to reduce
defects and waste, focusing on process
improvement and efficiency.
* **ISO Evolution and Integration:** The first version was
issued in 1987. ISO 9001:2015 incorporated risk-
based thinking and simplified documentation,
adapting to the changing business context.
* **Quality 4.0:** Emerging from the digital
transformation of industries, Quality 4.0 combines
traditional quality methods with new technologies
like AI and Machine Learning, enhancing quality
practices in the digital era.

> Now with this let's talk about what is the business sense of quality. Why should we be focusing on quality. Let's talk about that in the next video.
...
So basically, if we look back and think that what is quality?
Basically quality is doing the job right.

Whatever job each of us has been assigned, if we do that job right, then everything will work good
and our product or service will be good.

That is what basically quality would mean when I just look at quality very isolated from my area of
work.
```

* **Quality work means we do our jobs well, which makes our products better and our customers happier.**
* When we build things right, we save time and money,
and our company stands out from the competition.
* Doing quality work leads to more business, which
means more secure jobs and opportunities to grow.
* Each one of us matters. When we take pride in our
work, our company shines, and so do we.
* Better quality today means a better future for us
tomorrow.

```txt
So if I do my area of work, my assigned work properly, then I expect that the end product or the end
service will be good.

That will lead to client satisfaction.
Client will be happy.
That means as a company, our company will get more business.

Our company will get more market share because we are able to provide goods or services better than
our competitors.

And once our company grows, basically that will lead to our growth as well.
And that's how I look at quality.
```

```txt
So quality is basically everyone's responsibility.
So if everyone does their job properly in a good way, that will lead to quality.
That will lead to the success of the company.

And the success of the company means success of each and every individual who are working in that company.
```

```txt
On the other hand, let's look at the negative aspect of that.
If the company is doing a poor job, poor job means the client will leave that company, go to the competitors.

That means the market share of this company will lose, and slowly the company will be dropping its
profits.

That might lead to people getting laid off.
And then in the end, in the worst case scenario, maybe the company might get bankrupt or might leave
the business.

So this is when we look at the other extreme, when the product or the service quality is bad, which

will lead to the downfall of the company and the downfall of the company would actually mean the downfall
of people who are working in that company.
```
...
Do a good job.
Company succeeds.
Company succeed. You also succeed as a part of company.
```
...
## QA , QC and QMS - Basic Defintion

### Inspection: Checking Our Work

* Just like a chef tastes a dish before serving, we check
our work to make sure it's done right.
* When we inspect our products, we ensure our
customers get what they expect every single time.
* Think of inspection as our attention to detail-making
sure each product is up to the mark before it reaches
the customer's hands.
* **Formal Definition:** Inspection in quality management
refers to the **determination of conformity to specified requirements.** The result of an inspection can show conformity or nonconformity, or a degree of conformity.
(ISO 9001:2015)

### Quality Control: Keeping Quality Consistent

* Controlling our processes is like following a recipe
for success - it helps us repeat our good work
without mistakes.
* By controlling how we work, we can be proud of
what we make every day.
* Control keeps us on track, ensuring we make
products right every time, just like a well-tuned
assembly line that delivers perfection.
* **Formal Definition:** Quality Control is a part of
quality management focused on fulfilling quality
requirements. (ISO 9001:2015)

> So quality control basically ensures that our product is right each time.
> And it is just like a well tuned manufacturing line where each and every item is being inspected, and we make sure that the quality is under control.

### Quality Assurance: Commitment to Excellence

* Quality Assurance is our promise that we
stand by our work and that our customers can
trust what we create. (provide confidence to
customer)
* This promise keeps our customers coming
back and keeps our jobs secure.
* **Formal Definition:** Quality Assurance is a part
...
```txt
So this is broadly the difference between QA and QC.
Now if you say which one is good, both have their own purpose, both have their own reasons and both
should exist together.

It's not something that you just work on QA and you do not need QC.
You need both of them.

And both of them are important aspect in achieving quality.
So this completes our section on fundamentals of quality.

And as a next step we will be looking at QMS or the quality Management system and how that is used to
transform business.
```
